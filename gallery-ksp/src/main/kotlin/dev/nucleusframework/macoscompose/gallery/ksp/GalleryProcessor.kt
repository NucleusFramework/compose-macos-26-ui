package dev.nucleusframework.macoscompose.gallery.ksp
...
class GalleryProcessor(
    ...
    override fun process(resolver: Resolver): List<KSAnnotated> {
        ...
        val annotationName = "dev.nucleusframework.macoscompose.gallery.GalleryExample"
        ...
        val code = buildString {
            ...
            appendLine("package dev.nucleusframework.macoscompose.sample.gallery.generated")
            appendLine()
        ...
        codeGenerator.createNewFile(
            ...
            packageName = "dev.nucleusframework.macoscompose.sample.gallery.generated",
